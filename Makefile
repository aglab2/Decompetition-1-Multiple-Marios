...
ifeq ($(GRUCODE),f3dex) # Fast3DEX
  ...
  DEFINES += F3DEX3=1 F3DEX_GBI_SHARED=1
...
$(BUILD_DIR)/src/audio/heap.o:          OPT_FLAGS := -Os -fno-jump-tables $(GCC_MAIN_OPT_FLAGS)
$(BUILD_DIR)/src/audio/synthesis.o:     OPT_FLAGS := -Os -fno-jump-tables $(GCC_MAIN_OPT_FLAGS)
